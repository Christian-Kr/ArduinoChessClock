...
class TFTSevenSegmentClockDisplay : public TFTSevenSegmentDisplay {
  ...
  public:
    TFTSevenSegmentClockDisplay(  Elegoo_TFTLCD* ,  int16_t  ,  int16_t,  int16_t,  int16_t,  uint16_t,  uint16_t,  int16_t );
    /*!
    ...
    */
    TFTSevenSegmentClockDisplay(Elegoo_TFTLCD * , int16_t , int16_t , int16_t , int16_t , uint16_t , uint16_t , int16_t , boolean, float );

...
// 'pause1', 32x32px
const uint8_t epd_bitmap_pause[128] PROGMEM = {
...
// 'reset', 32x32px
const uint8_t epd_bitmap_reset[128] PROGMEM = {
...
// 'settings', 32x32px
const uint8_t epd_bitmap_settings[128] PROGMEM = {
...
// 'pawn', 16x16px
const uint8_t epd_bitmap_pawn[32] PROGMEM = {
...
void drawRect(int16_t x, int16_t y, int16_t w, int16_t h,
  ...
  for (uint16_t i = 0; i < borderWidth; i++) {
    tft.drawFastHLine(x + i, y + i, w - 2 * i, color);
    tft.drawFastHLine(x + i, y + h - 1 - i, w - 2 * i, color);
    tft.drawFastVLine(x + i, y + i, h - 2 * i, color);
    tft.drawFastVLine(x + w - 1 - i, y + i, h - 2 * i, color);
